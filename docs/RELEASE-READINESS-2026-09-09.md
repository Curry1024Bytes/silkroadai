...
operator 随后明确安排上线，`prod@d3c60d3` 已于北京时间 2026-09-09 15:33 部署；76 条 migration、Nginx 隔离及只读验收已通过，两个功能仍关闭。本文保留上线前判断，实际切换、备份、回滚和验收限制见 [生产发布记录](DEPLOY-2026-09-09.md)。
